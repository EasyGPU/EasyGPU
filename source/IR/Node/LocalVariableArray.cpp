/**
 * @file LocalVariableArray.cpp
 * @brief Implementation of local array declaration IR node.
 */
...
LocalVariableArrayNode::LocalVariableArrayNode(std::string Name, std::string Type, int Size)
