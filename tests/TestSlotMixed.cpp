...
int main() {
    try {
        ...
        // ==================================================================
        {
            ...
            for (int i = 0; i < 16 * 16; ++i) bufData[i] = static_cast<float>(i);
        ...
        // ==================================================================
        {
            ...
            Callable<Float(Float)> Process = [](Float& x) {
                Return(x * x + 1.0f);
            };
            ...
            bool pass = FloatEq(result[0], 2.0f) && FloatEq(result[1], 5.0f) && 
                        FloatEq(result[2], 10.0f) && FloatEq(result[3], 17.0f);
