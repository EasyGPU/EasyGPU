...
GPU::Kernel::InspectorKernel kernel([](Var<int> &id) {
	...
	Var<Vec3>  v3	  = MakeFloat3(0.5f, 0.5f, 0.5f);
...
GPU::Kernel::InspectorKernel kernel([](Var<int> &id) {
	...
	Var<Vec3>  fv3 = MakeFloat3(1.5f, 2.5f, 3.5f);
...
GPU::Kernel::InspectorKernel kernel([](Var<int> &id) {
	...
	// Vec2 operations
	Var<Vec2>  vv1 = MakeFloat2(1.0f, 2.0f);
	Var<Vec2>  vv2 = MakeFloat2(3.0f, 4.0f);
	Expr<Vec2> ve1 = vv1 + vv2;
	Var<Vec2>  vr1 = vv1 + ve1;

	// Vec4 operations
	Var<Vec4>  v4a = MakeFloat4(1.0f, 2.0f, 3.0f, 4.0f);
	Var<Vec4>  v4b = MakeFloat4(5.0f, 6.0f, 7.0f, 8.0f);
...
GPU::Kernel::InspectorKernel kernel([](Var<int> &id) {
	Var<IVec3>	v1	 = MakeInt3(1, 2, 3);
	Var<IVec3>	v2	 = MakeInt3(4, 5, 6);
	...
	Var<IVec2>	iv2b = MakeInt2(3, 4);
	Expr<IVec2> ie2	 = iv2a + iv2b;
	Var<IVec2>	ir2	 = iv2a & ie2;

	// IVec4
	Var<IVec4>	iv4a = MakeInt4(1, 2, 3, 4);
	Var<IVec4>	iv4b = MakeInt4(5, 6, 7, 8);
