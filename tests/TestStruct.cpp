...
EASYGPU_STRUCT(Material, (GPU::Math::Vec3, albedo), (float, roughness), (float, metallic));

EASYGPU_STRUCT(Particle, (GPU::Math::Vec3, position), (GPU::Math::Vec3, velocity), (float, life), (int, type));

// Define structures that depend on leaf structures
EASYGPU_STRUCT(RenderObject, (Particle, particle), (Material, material), (int, objectId));
