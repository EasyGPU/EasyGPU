...
Kernel::Kernel1D kernel([&](Var<int> &id) { Var<int> x = id * 2; });
...
Kernel::Kernel2D kernel([&](Var<int> &x, Var<int> &y) { Var<int> sum = x + y; });
...
Kernel::Kernel3D kernel([&](Var<int> &x, Var<int> &y, Var<int> &z) { Var<int> sum = x + y + z; });
