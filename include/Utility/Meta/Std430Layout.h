 ...
 */
template <typename T> constexpr size_t GetCPPSize() {
	return sizeof(T);
}

// Forward declarations for math types - defined in Vec.h/Matrix.h
// We need these to avoid including full headers here
template <> constexpr size_t GetCPPSize<GPU::Math::Vec2>() {
	return 8;
} // 2 * 4
template <> constexpr size_t GetCPPSize<GPU::Math::Vec3>() {
	return 12;
} // 3 * 4
template <> constexpr size_t GetCPPSize<GPU::Math::Vec4>() {
	return 16;
} // 4 * 4
template <> constexpr size_t GetCPPSize<GPU::Math::IVec2>() {
	return 8;
}
template <> constexpr size_t GetCPPSize<GPU::Math::IVec3>() {
	return 12;
}
template <> constexpr size_t GetCPPSize<GPU::Math::IVec4>() {
	return 16;
}
template <> constexpr size_t GetCPPSize<GPU::Math::Mat2>() {
	return 16;
} // 2 * vec2(8) aligned to 16 in CPU? Actually 16 for 2x vec4
template <> constexpr size_t GetCPPSize<GPU::Math::Mat3>() {
	return 36;
} // 3 * vec3(12)
template <> constexpr size_t GetCPPSize<GPU::Math::Mat4>() {
	return 64;
} // 4 * vec4(16)
template <> constexpr size_t GetCPPSize<GPU::Math::Mat2x3>() {
	return 24;
} // 2 * vec3(12)
template <> constexpr size_t GetCPPSize<GPU::Math::Mat2x4>() {
	return 32;
} // 2 * vec4(16)
template <> constexpr size_t GetCPPSize<GPU::Math::Mat3x2>() {
	return 24;
} // 3 * vec2(8)
template <> constexpr size_t GetCPPSize<GPU::Math::Mat3x4>() {
	return 48;
} // 3 * vec4(16)
template <> constexpr size_t GetCPPSize<GPU::Math::Mat4x2>() {
	return 32;
} // 4 * vec2(8)
template <> constexpr size_t GetCPPSize<GPU::Math::Mat4x3>() {
	return 48;
} // 4 * vec3(12)
 ...
 */
template <typename T> constexpr size_t GetStd430SizeHelper() {
	return sizeof(T);
}

template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Vec2>() {
	return 8;
}
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Vec3>() {
	return 16;
} // vec3 aligned to 16 in std430!
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Vec4>() {
	return 16;
}
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::IVec2>() {
	return 8;
}
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::IVec3>() {
	return 16;
} // ivec3 aligned to 16
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::IVec4>() {
	return 16;
}
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Mat2>() {
	return 32;
} // 2 columns * 16 (each vec2 aligned to 16)
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Mat3>() {
	return 48;
} // 3 columns * 16 (each vec3 aligned to 16)
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Mat4>() {
	return 64;
} // 4 columns * 16
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Mat2x3>() {
	return 32;
} // 2 columns * 16 (vec3 aligned to 16)
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Mat2x4>() {
	return 32;
} // 2 columns * 16
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Mat3x2>() {
	return 48;
} // 3 columns * 16 (vec2 aligned to 16 in matrix column)
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Mat3x4>() {
	return 48;
} // 3 columns * 16
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Mat4x2>() {
	return 64;
} // 4 columns * 16
template <> constexpr size_t GetStd430SizeHelper<GPU::Math::Mat4x3>() {
	return 64;
} // 4 columns * 16 (vec3 aligned to 16)
 ...
 */
template <typename T> constexpr bool NeedsLayoutConversionHelper() {
 ...
 */
template <typename T> class Std430Converter : public LayoutConverter {
public:
	Std430Converter() {
	...
	size_t GetCPPLayoutSize() const override {
		return _cppSize;
	}
	size_t GetGPULayoutSize() const override {
		return _gpuSize;
	}
	bool NeedsConversion() const override {
		return _needsConversion;
	}
 ...
 * Factory function
 */
template <typename T> std::unique_ptr<LayoutConverter> GetLayoutConverter() {
