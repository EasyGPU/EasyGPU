 ...
 */
[[nodiscard]] inline IR::Value::Expr<int> AtomicAdd(const IR::Value::Expr<int>& target, const IR::Value::Expr<int>& value) {
 ...
 */
[[nodiscard]] inline IR::Value::Expr<float> AtomicAdd(const IR::Value::Expr<float>& target, const IR::Value::Expr<float>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
 ...
 */
[[nodiscard]] inline IR::Value::Expr<int> AtomicSub(const IR::Value::Expr<int>& target, const IR::Value::Expr<int>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
 ...
 */
[[nodiscard]] inline IR::Value::Expr<int> AtomicMin(const IR::Value::Expr<int>& target, const IR::Value::Expr<int>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
 ...
 */
[[nodiscard]] inline IR::Value::Expr<float> AtomicMin(const IR::Value::Expr<float>& target, const IR::Value::Expr<float>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
 ...
 */
[[nodiscard]] inline IR::Value::Expr<int> AtomicMax(const IR::Value::Expr<int>& target, const IR::Value::Expr<int>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
 ...
 */
[[nodiscard]] inline IR::Value::Expr<float> AtomicMax(const IR::Value::Expr<float>& target, const IR::Value::Expr<float>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
 ...
 */
[[nodiscard]] inline IR::Value::Expr<int> AtomicAnd(const IR::Value::Expr<int>& target, const IR::Value::Expr<int>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
 ...
 */
[[nodiscard]] inline IR::Value::Expr<int> AtomicOr(const IR::Value::Expr<int>& target, const IR::Value::Expr<int>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
 ...
 */
[[nodiscard]] inline IR::Value::Expr<int> AtomicXor(const IR::Value::Expr<int>& target, const IR::Value::Expr<int>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
 ...
 */
[[nodiscard]] inline IR::Value::Expr<int> AtomicExchange(const IR::Value::Expr<int>& target, const IR::Value::Expr<int>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
 ...
 */
[[nodiscard]] inline IR::Value::Expr<float> AtomicExchange(const IR::Value::Expr<float>& target, const IR::Value::Expr<float>& value) {
	std::string targetStr = IR::Builder::Builder::Get().BuildNode(*target.Node());
	std::string valueStr = IR::Builder::Builder::Get().BuildNode(*value.Node());
