 ...
 */
template <IR::Value::ScalarType T> inline void Return(const IR::Value::Expr<T> &value) {
 ...
 * @param value The expression to return
 */
template <IR::Value::ScalarType T> inline void Return(IR::Value::Expr<T> &&value) {
 ...
 */
template <IR::Value::ScalarType T> inline void Return(T value) {
 ...
 */
template <IR::Value::ScalarType T> inline void Return(const IR::Value::Var<T> &var) {
