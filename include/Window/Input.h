 ...
 * @brief Keyboard keys
 *
 * Maps to minifb key codes for internal use, but provides a clean
 * EasyGPU-native API that won't break if the backend changes.
 */
...
inline bool HasModifier(ModifierFlags flags, ModifierFlags flag) {
	return (static_cast<uint32_t>(flags) & static_cast<uint32_t>(flag)) != 0;
}

} // namespace GPU::Window

#endif // EASYGPU_WINDOW_INPUT_H
