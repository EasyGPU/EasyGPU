...
template <typename T> void EASYGPU_RegisterIfStruct() {
}
...
#define EASYGPU_VAR_SPEC_1(StructType, P1)                                                                             \
	...
	public:                                                                                                            \
		...
		EASYGPU_MEMBER_ACCESS P1 /* Copy constructor - handle external variables correctly */                          \
		Var(const Var &Other) {                                                                                        \
...
#define EASYGPU_VAR_SPEC_2(StructType, P1, P2)                                                                         \
	...
	public:                                                                                                            \
		...
		EASYGPU_MEMBER_ACCESS P1 EASYGPU_MEMBER_ACCESS P2 Var &operator=(const Var &other) {                           \
			if (this != &other) {                                                                                      \
				auto store = std::make_unique<Node::StoreNode>(Load(), other.Load());                                  \
				Builder::Builder::Get().Build(*store, true);                                                           \
			}                                                                                                          \
...
#define EASYGPU_VAR_SPEC_3(StructType, P1, P2, P3)                                                                     \
	...
	public:                                                                                                            \
		...
		EASYGPU_MEMBER_ACCESS P1 EASYGPU_MEMBER_ACCESS P2 EASYGPU_MEMBER_ACCESS P3 Var &operator=(const Var &other) {  \
			if (this != &other) {                                                                                      \
				auto store = std::make_unique<Node::StoreNode>(Load(), other.Load());                                  \
				Builder::Builder::Get().Build(*store, true);                                                           \
			}                                                                                                          \
...
#define EASYGPU_VAR_SPEC_4(StructType, P1, P2, P3, P4)                                                                 \
	...
	public:                                                                                                            \
		...
		EASYGPU_MEMBER_ACCESS P1 EASYGPU_MEMBER_ACCESS P2 EASYGPU_MEMBER_ACCESS P3 EASYGPU_MEMBER_ACCESS P4 Var &      \
...
#define EASYGPU_VAR_SPEC(StructType, ...)                                                                              \
	EASYGPU_VAR_SPEC_IMPL(StructType, EASYGPU_COUNT_ARGS(__VA_ARGS__), __VA_ARGS__)
