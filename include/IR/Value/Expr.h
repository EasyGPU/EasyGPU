...
template <> struct ElementType<Math::Vec2> {
	using type = float;
};
template <> struct ElementType<Math::Vec3> {
	using type = float;
};
template <> struct ElementType<Math::Vec4> {
	using type = float;
};
template <> struct ElementType<Math::IVec2> {
	using type = int;
};
template <> struct ElementType<Math::IVec3> {
	using type = int;
};
template <> struct ElementType<Math::IVec4> {
	using type = int;
};
...
template <> struct VecDimension<Math::Vec2> {
	static constexpr int value = 2;
};
template <> struct VecDimension<Math::Vec3> {
	static constexpr int value = 3;
};
template <> struct VecDimension<Math::Vec4> {
	static constexpr int value = 4;
};
template <> struct VecDimension<Math::IVec2> {
	static constexpr int value = 2;
};
template <> struct VecDimension<Math::IVec3> {
	static constexpr int value = 3;
};
template <> struct VecDimension<Math::IVec4> {
	static constexpr int value = 4;
};
...
template <> struct MatrixTraits<Math::Mat2> {
	static constexpr int cols = 2;
	static constexpr int rows = 2;
};
template <> struct MatrixTraits<Math::Mat3> {
	static constexpr int cols = 3;
	static constexpr int rows = 3;
};
template <> struct MatrixTraits<Math::Mat4> {
	static constexpr int cols = 4;
	static constexpr int rows = 4;
};
template <> struct MatrixTraits<Math::Mat2x3> {
	static constexpr int cols = 2;
	static constexpr int rows = 3;
};
template <> struct MatrixTraits<Math::Mat2x4> {
	static constexpr int cols = 2;
	static constexpr int rows = 4;
};
template <> struct MatrixTraits<Math::Mat3x2> {
	static constexpr int cols = 3;
	static constexpr int rows = 2;
};
template <> struct MatrixTraits<Math::Mat3x4> {
	static constexpr int cols = 3;
	static constexpr int rows = 4;
};
template <> struct MatrixTraits<Math::Mat4x2> {
	static constexpr int cols = 4;
	static constexpr int rows = 2;
};
template <> struct MatrixTraits<Math::Mat4x3> {
	static constexpr int cols = 4;
	static constexpr int rows = 3;
};
 ...
 */
template <ScalarType T> class Expr : public ExprBase {
public:
	/**
...
public:
	 ...
	 */
	template <CountableType IndexType> Expr<ElementType_t> operator[](IndexType index) && {
		auto uniform = std::make_unique<Node::LoadUniformNode>(ValueToString(index));
		return Expr<ElementType_t>(std::make_unique<Node::ArrayAccessNode>(this->Release(), std::move(uniform)));
	}
	...
	template <ScalarType IndexT> Expr<ElementType_t> operator[](Expr<IndexT> index) && {
		return Expr<ElementType_t>(std::make_unique<Node::ArrayAccessNode>(this->Release(), index.Release()));
	}

	template <ScalarType IndexT> Expr<ElementType_t> operator[](Expr<IndexT> index) & = delete;

public:
	// Arithmetic operations: Expr<T> + Expr<T>
	friend Expr<T> operator+(const Expr<T> &lhs, const Expr<T> &rhs) {
		return Expr<T>(std::make_unique<Node::OperationNode>(Node::OperationCode::Add, CloneNode(lhs), CloneNode(rhs)));
	}

	friend Expr<T> operator-(const Expr<T> &lhs, const Expr<T> &rhs) {
		return Expr<T>(std::make_unique<Node::OperationNode>(Node::OperationCode::Sub, CloneNode(lhs), CloneNode(rhs)));
	}

	friend Expr<T> operator*(const Expr<T> &lhs, const Expr<T> &rhs) {
		return Expr<T>(std::make_unique<Node::OperationNode>(Node::OperationCode::Mul, CloneNode(lhs), CloneNode(rhs)));
	}
	...
	{
		return Expr<T>(
			std::make_unique<Node::OperationNode>(Node::OperationCode::BitAnd, CloneNode(lhs), CloneNode(rhs)));
	}
	...
	{
		return Expr<T>(
			std::make_unique<Node::OperationNode>(Node::OperationCode::BitOr, CloneNode(lhs), CloneNode(rhs)));
	}
	...
	{
		return Expr<T>(
			std::make_unique<Node::OperationNode>(Node::OperationCode::BitXor, CloneNode(lhs), CloneNode(rhs)));
	}
	...
	friend Expr<T> operator~(const Expr<T> &val)
		requires BitableType<T> || std::same_as<T, Math::IVec2> || std::same_as<T, Math::IVec3> ||
				 std::same_as<T, Math::IVec4>
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(Node::OperationCode::BitNot, CloneNode(val)));
	}
	...
	friend Expr<T> operator<<(const Expr<T> &lhs, const Expr<T> &rhs)
		requires BitableType<T> || std::same_as<T, Math::IVec2> || std::same_as<T, Math::IVec3> ||
				 std::same_as<T, Math::IVec4>
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(Node::OperationCode::Shl, CloneNode(lhs), CloneNode(rhs)));
	}
	...
	friend Expr<T> operator>>(const Expr<T> &lhs, const Expr<T> &rhs)
		requires BitableType<T> || std::same_as<T, Math::IVec2> || std::same_as<T, Math::IVec3> ||
				 std::same_as<T, Math::IVec4>
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(Node::OperationCode::Shr, CloneNode(lhs), CloneNode(rhs)));
	}
		...
		requires std::same_as<U, int>
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::BitAnd, lhs.Release(), std::make_unique<Node::LoadUniformNode>(ValueToString(rhs))));
	}
	...
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::BitAnd, std::make_unique<Node::LoadUniformNode>(ValueToString(lhs)), rhs.Release()));
	}
	...
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::BitOr, lhs.Release(), std::make_unique<Node::LoadUniformNode>(ValueToString(rhs))));
	}
	...
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::BitOr, std::make_unique<Node::LoadUniformNode>(ValueToString(lhs)), rhs.Release()));
	}
	...
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::BitXor, lhs.Release(), std::make_unique<Node::LoadUniformNode>(ValueToString(rhs))));
	}
	...
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::BitXor, std::make_unique<Node::LoadUniformNode>(ValueToString(lhs)), rhs.Release()));
	}
	...
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Shl, lhs.Release(), std::make_unique<Node::LoadUniformNode>(ValueToString(rhs))));
	}
	...
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Shr, lhs.Release(), std::make_unique<Node::LoadUniformNode>(ValueToString(rhs))));
	}
	...
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Mod, lhs.Release(), std::make_unique<Node::LoadUniformNode>(ValueToString(rhs))));
	}
	...
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Mod, std::make_unique<Node::LoadUniformNode>(ValueToString(lhs)), rhs.Release()));
	}
	...
	friend Expr<bool> operator<=(Expr<T> lhs, Expr<T> rhs) {
		return Expr<bool>(
			std::make_unique<Node::OperationNode>(Node::OperationCode::LessEqual, lhs.Release(), rhs.Release()));
	}

	friend Expr<bool> operator>=(Expr<T> lhs, Expr<T> rhs) {
		return Expr<bool>(
			std::make_unique<Node::OperationNode>(Node::OperationCode::GreaterEqual, lhs.Release(), rhs.Release()));
	}
	...
	{
		return Expr<T>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Div, std::make_unique<Node::LoadUniformNode>(ValueToString(lhs)), rhs.Release()));
	}
	...
	friend Expr<bool> operator<(Expr<T> lhs, T rhs)
		requires std::same_as<U, float> || std::same_as<U, int>
	{
		return Expr<bool>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Less, lhs.Release(), std::make_unique<Node::LoadUniformNode>(ValueToString(rhs))));
	}
	...
	{
		return Expr<bool>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Less, std::make_unique<Node::LoadUniformNode>(ValueToString(lhs)), rhs.Release()));
	}
	...
	{
		return Expr<bool>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Greater, lhs.Release(), std::make_unique<Node::LoadUniformNode>(ValueToString(rhs))));
	}
	...
	{
		return Expr<bool>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Greater, std::make_unique<Node::LoadUniformNode>(ValueToString(lhs)), rhs.Release()));
	}
	...
	{
		return Expr<bool>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Equal, lhs.Release(), std::make_unique<Node::LoadUniformNode>(ValueToString(rhs))));
	}
	...
	{
		return Expr<bool>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::Equal, std::make_unique<Node::LoadUniformNode>(ValueToString(lhs)), rhs.Release()));
	}
	...
	{
		return Expr<bool>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::NotEqual, lhs.Release(), std::make_unique<Node::LoadUniformNode>(ValueToString(rhs))));
	}
	...
	{
		return Expr<bool>(std::make_unique<Node::OperationNode>(
			Node::OperationCode::NotEqual, std::make_unique<Node::LoadUniformNode>(ValueToString(lhs)), rhs.Release()));
	}
	...
	{
		return Expr<bool>(
			std::make_unique<Node::OperationNode>(Node::OperationCode::LogicalAnd, CloneNode(lhs), CloneNode(rhs)));
	}
	...
	{
		return Expr<bool>(
			std::make_unique<Node::OperationNode>(Node::OperationCode::LogicalOr, CloneNode(lhs), CloneNode(rhs)));
	}
	...
	friend Expr<bool> operator!(const Expr<T> &val)
		requires std::same_as<U, bool>
	{
		return Expr<bool>(std::make_unique<Node::OperationNode>(Node::OperationCode::LogicalNot, CloneNode(val)));
	}
