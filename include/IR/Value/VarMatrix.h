...
public:
	...
	template <typename C0, typename C1>
		requires(std::same_as<std::remove_cvref_t<C0>, Var<Math::Vec2>> ||
				...
				(std::same_as<std::remove_cvref_t<C1>, Var<Math::Vec2>> ||
				 std::same_as<std::remove_cvref_t<C1>, Expr<Math::Vec2>>)
...
public:
	template <CountableType T> Var<Math::Vec2> operator[](T Index) {
	...
	template <ScalarType IndexT> Var<Math::Vec2> operator[](Expr<IndexT> Index) {
		std::string exprStr = Builder::Builder::Get().BuildNode(*Index.Node());
		return {std::format("{}[{}]", _varNode->VarName(), exprStr)};
	}
...
private:
	...
	template <typename T> static std::string ColumnToString(T &&val) {
...
public:
	...
	template <typename C0, typename C1, typename C2>
		requires(std::same_as<std::remove_cvref_t<C0>, Var<Math::Vec3>> ||
				...
				(std::same_as<std::remove_cvref_t<C1>, Var<Math::Vec3>> ||
				 std::same_as<std::remove_cvref_t<C1>, Expr<Math::Vec3>>) &&
				(std::same_as<std::remove_cvref_t<C2>, Var<Math::Vec3>> ||
				 std::same_as<std::remove_cvref_t<C2>, Expr<Math::Vec3>>)
...
public:
	template <CountableType T> Var<Math::Vec3> operator[](T Index) {
	...
	template <ScalarType IndexT> Var<Math::Vec3> operator[](Expr<IndexT> Index) {
		std::string exprStr = Builder::Builder::Get().BuildNode(*Index.Node());
		return {std::format("{}[{}]", _varNode->VarName(), exprStr)};
	}
...
public:
	...
	template <typename C0, typename C1, typename C2, typename C3>
		requires(std::same_as<std::remove_cvref_t<C0>, Var<Math::Vec4>> ||
				...
				(std::same_as<std::remove_cvref_t<C1>, Var<Math::Vec4>> ||
				 std::same_as<std::remove_cvref_t<C1>, Expr<Math::Vec4>>) &&
				(std::same_as<std::remove_cvref_t<C2>, Var<Math::Vec4>> ||
				 std::same_as<std::remove_cvref_t<C2>, Expr<Math::Vec4>>) &&
				(std::same_as<std::remove_cvref_t<C3>, Var<Math::Vec4>> ||
				 std::same_as<std::remove_cvref_t<C3>, Expr<Math::Vec4>>)
...
public:
	template <CountableType T> Var<Math::Vec4> operator[](T Index) {
	...
	template <ScalarType IndexT> Var<Math::Vec4> operator[](Expr<IndexT> Index) {
		std::string exprStr = Builder::Builder::Get().BuildNode(*Index.Node());
		return {std::format("{}[{}]", _varNode->VarName(), exprStr)};
	}
...
private:
	template <typename T> static std::string Vec3ToString(T &&val) {
		using U = std::remove_cvref_t<T>;
		if constexpr (std::same_as<U, Expr<Math::Vec3>>) {
			return Builder::Builder::Get().BuildNode(*val.Node());
		} else if constexpr (std::same_as<U, Var<Math::Vec3>>) {
...
private:
	template <typename T> static std::string Vec4ToString(T &&val) {
		using U = std::remove_cvref_t<T>;
		if constexpr (std::same_as<U, Expr<Math::Vec4>>) {
			return Builder::Builder::Get().BuildNode(*val.Node());
		} else if constexpr (std::same_as<U, Var<Math::Vec4>>) {
...
public:
	...
	template <typename C0, typename C1, typename C2>
		requires(std::same_as<std::remove_cvref_t<C0>, Var<Math::Vec2>> ||
				...
				(std::same_as<std::remove_cvref_t<C1>, Var<Math::Vec2>> ||
				 std::same_as<std::remove_cvref_t<C1>, Expr<Math::Vec2>>) &&
				(std::same_as<std::remove_cvref_t<C2>, Var<Math::Vec2>> ||
				 std::same_as<std::remove_cvref_t<C2>, Expr<Math::Vec2>>)
	Var(C0 &&col0, C1 &&col1, C2 &&col2) : VarBase() {
...
private:
	template <typename T> static std::string Vec2ToString(T &&val) {
		using U = std::remove_cvref_t<T>;
		if constexpr (std::same_as<U, Expr<Math::Vec2>>) {
			return Builder::Builder::Get().BuildNode(*val.Node());
		} else if constexpr (std::same_as<U, Var<Math::Vec2>>) {
...
public:
	...
	template <typename C0, typename C1, typename C2, typename C3>
		requires(std::same_as<std::remove_cvref_t<C0>, Var<Math::Vec2>> ||
				...
				(std::same_as<std::remove_cvref_t<C2>, Var<Math::Vec2>> ||
				 std::same_as<std::remove_cvref_t<C2>, Expr<Math::Vec2>>) &&
				(std::same_as<std::remove_cvref_t<C3>, Var<Math::Vec2>> ||
				 std::same_as<std::remove_cvref_t<C3>, Expr<Math::Vec2>>)
	Var(C0 &&col0, C1 &&col1, C2 &&col2, C3 &&col3) : VarBase() {
		std::string c0Str = Vec2ToString(std::forward<C0>(col0));
		std::string c1Str = Vec2ToString(std::forward<C1>(col1));
		std::string c2Str = Vec2ToString(std::forward<C2>(col2));
...
public:
	...
	template <typename C0, typename C1, typename C2, typename C3>
		requires(std::same_as<std::remove_cvref_t<C0>, Var<Math::Vec3>> ||
				...
				(std::same_as<std::remove_cvref_t<C2>, Var<Math::Vec3>> ||
				 std::same_as<std::remove_cvref_t<C2>, Expr<Math::Vec3>>) &&
				(std::same_as<std::remove_cvref_t<C3>, Var<Math::Vec3>> ||
				 std::same_as<std::remove_cvref_t<C3>, Expr<Math::Vec3>>)
	Var(C0 &&col0, C1 &&col1, C2 &&col2, C3 &&col3) : VarBase() {
		std::string c0Str = Vec3ToString(std::forward<C0>(col0));
		std::string c1Str = Vec3ToString(std::forward<C1>(col1));
