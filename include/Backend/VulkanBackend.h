...
public:
    ...
    void UploadTexture(TextureHandle texture, uint32_t x, uint32_t y,
                       uint32_t width, uint32_t height, const void* data) override;
    void DownloadTexture(TextureHandle texture, uint32_t x, uint32_t y,
                         uint32_t width, uint32_t height, void* outData) override;
    ...
    void SetUniform(PipelineHandle pipeline, const std::string& name,
                    const std::string& type, const void* data) override;
...
private:
    ...
    void UploadTextureInternal(TextureInfo& info, uint32_t x, uint32_t y,
                               uint32_t width, uint32_t height, const void* data);
    void EnsureNoPendingGpuWork();
    void TransitionTexture(TextureInfo& info, VkImageLayout newLayout,
    ...
    // Barrier helpers
    void InsertBufferBarrier(VkBuffer buffer, size_t offset, size_t size, 
