...
namespace GPU::Runtime {
     ...
     */
    template<typename T>
    class BufferSlot : public BufferSlotBase {
    public:
        /**
    ...
    protected:
        ...
        static const char* GetGLSLTypeName() {
        ...
        static int GetGLBufferMode(BufferMode mode) {
            switch (mode) {
                case BufferMode::Read:      return 0x88B8;  // GL_READ_ONLY
                case BufferMode::Write:     return 0x88B9;  // GL_WRITE_ONLY
                case BufferMode::ReadWrite: return 0x88BA;  // GL_READ_WRITE
            }
            return 0x88BA;
        }
