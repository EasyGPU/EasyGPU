...
public:
	...
	Buffer(Buffer &&other) noexcept
		: _bufferId(other._bufferId), _count(other._count), _elementSize(other._elementSize), _mode(other._mode),
		  _boundBinding(other._boundBinding), _layoutConverter(std::move(other._layoutConverter)) {
		other._bufferId		= 0;
		other._count		= 0;
...
public:
	...
	[[nodiscard]] IR::Value::BufferRef<T> Bind() {
		...
		context->RegisterBuffer(binding, typeName, bufferName, GetGLBufferMode(_mode));
