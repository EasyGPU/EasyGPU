...
int main() {
	...
	ADKernel1D kernel([&](Var<int> &id) {
		...
		e00 = Exp(s00);  e01 = Exp(s01);
		esum0 = e00 + e01;
		a00 = e00 / esum0;  a01 = e01 / esum0;

		// --- Softmax row 1 ---
		Var<float> e10, e11, esum1, a10, a11;
		e10 = Exp(s10);  e11 = Exp(s11);
		esum1 = e10 + e11;
		a10 = e10 / esum1;  a11 = e11 / esum1;

		// --- Attention output ---
		Var<float> y0_a, y0_b, y0, y1_a, y1_b, y1;
		y0_a = a00 * v0;  y0_b = a01 * v1;  y0 = y0_a + y0_b;
		y1_a = a10 * v0;  y1_b = a11 * v1;  y1 = y1_a + y1_b;
		...
		int pbv  = AD::Param(bv);
		AD::Loss(loss);
		(void)pwq; (void)pwk; (void)pwv; (void)pwo0; (void)pwo1;
		(void)pbq; (void)pbk; (void)pbv;
	}, N, groupSize);
